...
function Communicator() {
  ...
  var receiveMessage = function(message){
    ...
    log(parsedMessage.caller + ' >>> Me : ' + parsedMessage.content)
  ...
  // __ Public Methods _____________________________________________________
    ...
    logger = loggerObj
    log("Telegram Communicator Object has been created.")
    log("Waiting messages...")
	}
